...
public class SetUserInfoActivity extends BaseBActivity implements View.OnClickListener {
    ...
    private ImageView touXiang, img_edit_sex, img_edit_name1, img_edit_sign, img_edit_email, img_edit_place, img_edit_qq, img_edit_age;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_edit_age:
                ...
                Log.d("month:", strs[1]);
                Log.d("day:", strs[2]);
                DatePickerDialog dialog =new DatePickerDialog(SetUserInfoActivity.this, new DatePickerDialog.OnDateSetListener() {
                    Date date = new Date();
...
//                        xianshi_nianling.setText(year + "-" + monthOfYear + "-" + dayOfMonth);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0 && resultCode == RESULT_OK && null != data) {
            ...
            xianshi_place.setText(data.getExtras().getString("name1")+""+data.getExtras().getString("name2"));
...
//                    finish();
    ...
    private void initFlag(boolean changeName, boolean changeSex, boolean changeSign, boolean changeEmail, boolean birth, boolean qq,boolean dq) {
        CHANGESEX = changeSex;
