...
public class SetUserInfoActivity extends BaseBActivity implements View.OnClickListener {
  ...
  private static boolean CHANGEDQ = false;
  private static String IMG_ID = null;
  private ImageView touXiang, img_edit_sex, img_edit_name1, img_edit_sign, img_edit_email,
      img_edit_place, img_edit_qq, img_edit_age;
  private TextView xiangCe;
  private TextView xiangJi;
  private TextView xianshi_nicheng, xianshi_xingbie, xianshi_nianling, xianshi_qianming,
      xianshi_qq, xianshi_email, xianshi_place;
      ...
      public void handleMessage(Message msg) {
        switch (msg.what) {
          case 0:
            ...
            if (CHANGEDQ) {
              Toast.makeText(SetUserInfoActivity.this, "修改地区成功", Toast.LENGTH_SHORT).show();
            }
            break;
          case 404:
  ...
  private void initView() {
    ...
    img_edit_place = (ImageView) findViewById(R.id.img_edit_place);
    ...
    img_edit_place.setOnClickListener(this);
    ImageLoader.loadOptimizedHttpImage(this, imgHead).placeholder(R.drawable.side_user_avatar)
        .dontAnimate().into(touXiang);
  }
        ...
        new AlertDialog.Builder(this).setTitle("性别")
            .setSingleChoiceItems(sex_all, sex_flag, new DialogInterface.OnClickListener() {
              ...
              public void onClick(DialogInterface dialog, int which) {
                ...
                initFlag(false, true, false, false, false, false, false);
      ...
      case R.id.img_edit_name1:
        ...
        new AlertDialog.Builder(this).setTitle("昵称")
            ...
            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                initFlag(true, false, false, false, false, false, false);
                userApi.setHandler(myHandler);
      ...
      case R.id.img_edit_sign:
        ...
        new AlertDialog.Builder(this).setTitle("个性签名")
            ...
            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                initFlag(false, false, true, false, false, false, false);
                userApi.setHandler(myHandler);
        ...
        new AlertDialog.Builder(this).setTitle("邮箱")
            ...
            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
              ...
              public void onClick(DialogInterface dialog, int which) {
                ...
                initFlag(false, false, false, true, false, false, false);
                userApi.setHandler(myHandler);
      ...
      case R.id.img_edit_qq:
        ...
        new AlertDialog.Builder(this).setTitle("QQ")
            ...
            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                initFlag(false, false, false, false, false, true, false);
                userApi.setHandler(myHandler);
            ...
            .show();
        break;
      case R.id.img_edit_place:
        Intent intent1 = new Intent(SetUserInfoActivity.this, UserPlaceActivity.class);
...
//                        xianshi_nianling.setText(year + "-" + monthOfYear + "-" + dayOfMonth);
        ...
        GregorianCalendar calendar1 = new GregorianCalendar(2015, 12, 31);
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (requestCode == 0 && resultCode == RESULT_OK && null != data) {
      userApi.setHandler(myHandler);
      userApi.changePrivance(data.getExtras().getString("province"));
      userApi.setHandler(myHandler);
      userApi.changeCity(data.getExtras().getString("city"));
...
//                    finish();
  ...
  private void initFlag(boolean changeName, boolean changeSex, boolean changeSign, boolean
      changeEmail, boolean birth, boolean qq, boolean dq) {
    CHANGESEX = changeSex;
