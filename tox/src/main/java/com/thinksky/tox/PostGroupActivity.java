...
//                    Log.d("wj...", arg[1]);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    categoryList = (ArrayList<HashMap<String, String>>) getIntent().getSerializableExtra
        ("categoryList");
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      case R.id.post_Send:
        if (!"".equals(postSendTitleEdit.getText().toString().trim()) && !"".equals
            (postSendContentEdit.getText().toString().trim())) {
