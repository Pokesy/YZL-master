...
public class UserInfoActivityA extends Activity {
...
//        if (!Url.SESSIONID.equalsIgnoreCase("")) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (progress.getVisibility()==View.VISIBLE){
                    ...
                    ToastHelper.showToast("网络连接状态不稳定",UserInfoActivityA.this);
                }
            }
        },7000);
    ...
    private void initView() {
        ...
        ListBottem = new Button(UserInfoActivityA.this);
        ...
        ListBottem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (flag && listBottemFlag) {
                    ...
                    Toast.makeText(UserInfoActivityA.this, "正在加载中...", Toast.LENGTH_LONG).show();
            }
        });
        ...
        Detail_List.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent intent = new Intent(UserInfoActivityA.this,
    ...
    private class MainListOnItemClickListener implements OnItemClickListener {
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Intent intent = new Intent(UserInfoActivityA.this, WeiboDetailActivity.class);
            Bundle bund = new Bundle();
            Log.e("被点击啦啦啦啦啦", arg2+"");
        ...
        public void onClick(View v) {
            ...
            switch (mId) {
                ...
                case R.id.UserRevise:
                    // Intent intent = new Intent(UserInfoActivityA.this,.class);
                    // startActivity(intent);
                    break;
                case R.id.UserCamera:
                    if (userUid.equals(Url.USERID)) {
                        Intent intent = new Intent(UserInfoActivityA.this,SetUserInfoActivity.class);
                ...
                case R.id.Logout:
                    ...
                    new AlertDialog.Builder(UserInfoActivityA.this)
                            .setTitle("确认")
                            .setMessage("确定退出登入")
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    userApi1.logout();
                                    Intent intent = new Intent(UserInfoActivityA.this, MainActivity.class);
                ...
                case R.id.follow_btn:
                    if (!userApi.getSeesionId().equals("")) {
                        ...
                        ToastHelper.showToast("请登陆后操作",UserInfoActivityA.this);
                    }
                    break;
                default:
                    break;
    ...
    Handler followHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    if (followFlag){
                        ToastHelper.showToast("取消关注成功",UserInfoActivityA.this);
                        followBtn.setBackgroundColor(Color.parseColor("#3BAFDA"));
                        followFlag = false;
                        followBtn.setText("添加关注");
                    }else {
                        ToastHelper.showToast("关注成功", UserInfoActivityA.this);
    ...
    Handler hand = new Handler() {
        ...
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg.what == 404) {
                Toast.makeText(UserInfoActivityA.this, "请求失败，服务器故障", Toast.LENGTH_LONG).show();
                listBottemFlag = true;
            } else if (msg.what == 100) {
                Toast.makeText(UserInfoActivityA.this, "服务器无响应", Toast.LENGTH_LONG).show();
                listBottemFlag = true;
            } else if (msg.what == 0) {
                String result = (String) msg.obj;
                Log.e("result>>>>>>>>",result);
                ...
                if (result != null) {
                    ...
                    BaseFunction.showImage(UserInfoActivityA.this, mUserCamera, Url.MYUSERINFO.getAvatar(), loadImgHeadImg, Url.IMGTYPE_WEIBO);
                    if (userUid.equals(Url.USERID)) {
    ...
    private void saveUserInfoToNative() {
        ...
        if(Url.MYUSERINFO.getAvatar().equals(
            BaseFunction.getSharepreference("avatar",UserInfoActivityA.this, Url.SharedPreferenceName))){
