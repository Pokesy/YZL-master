...
public class ForumDetailActivity extends BaseBActivity implements View.OnClickListener {
  ...
  private void initView() {
    ...
    mHeaderView = LayoutInflater.from(this).inflate(R.layout.forum_detail_list_header, mListView,
        false);
  ...
  private TextWatcher watcher = new TextWatcher() {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
      if (count != 0) {
        ...
        mForumSendCom.setBackgroundDrawable(getResources().getDrawable(R.drawable
...
//                ToastHelper.showToast("refresh刷新",ctx);
  ...
  public class PagerAdapter extends FragmentPagerAdapter {
    ...
    public PagerAdapter(FragmentManager fm, List<ScrollTabHolderFragment> fragmentList,
                        List<ForumInfo> list) {
      super(fm);
...
//        insertPost();
   ...
   * 设置请求的类型
   */
  private void initFlag(boolean addForumPost, boolean getForumPost, boolean refresh, boolean
      getForums, boolean sendPostCom) {
...
//                mListView.addFooterView(noBtn);
  ...
  private void initForumData() {
    ...
    ImageLoader.loadOptimizedHttpImage(this, mForumBean.logo).placeholder(R.drawable.picture_no)
        .into(mForumLogo);
    BaseFunction.setLayoutBackGround(mForumLogo, this, mForumBackground, mForumBean.background,
        imgLoad);
  }
