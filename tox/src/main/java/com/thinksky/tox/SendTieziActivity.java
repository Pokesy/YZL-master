...
//                            progressDialog1.show(SendTieziActivity.this, "提示", "发布中...", true, false);
...
//        map.put("category_id", category_id);
        ...
        RsenUrlUtil.execute(this, RsenUrlUtil.URL_SEND_HT, new RsenUrlUtil.OnJsonResultListener<DiscoverFragment.FXBean>() {
            @Override
