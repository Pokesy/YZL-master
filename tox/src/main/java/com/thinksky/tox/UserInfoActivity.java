...
public class UserInfoActivity extends BaseBActivity {
    ...
    private TextView UserName, UserTitle, UserTime, signature, UserWriter, UserFollowing, UserFans, UserEmail, UserScore;
...
//        UserTime.setText(userInfo.getProvince() + "" + userInfo.getCity() + "" + userInfo.getDistrict());
