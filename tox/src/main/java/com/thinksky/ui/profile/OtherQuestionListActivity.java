...
public class OtherQuestionListActivity extends BaseBActivity {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    ((TextView) findViewById(R.id.group_name)).setText("他的问题");
    mListAdapter = new WendaListAdapter(OtherQuestionListActivity.this);
  ...
  public static Intent makeIntent(Context context, String userId) {
    Intent intent = new Intent(context, OtherQuestionListActivity.class);
  ...
  public class WendaListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      try {
        ImageLoader.loadOptimizedHttpImage(OtherQuestionListActivity.this, RsenUrlUtil.URL_BASE +
            listEntity.getUser().getAvatar32())
            .placeholder(R.drawable.side_user_avatar).error(R.drawable.side_user_avatar)
            .bitmapTransform(new CropCircleTransformation(OtherQuestionListActivity.this))
      ...
      if (listEntity.getImgList() != null && !listEntity.getImgList()
        ...
        for (int i = 0; i < size; i++) {
          ...
          if (imageView != null) {
            try {
              ImageLoader.loadOptimizedHttpImage(OtherQuestionListActivity.this, url).into
                  (imageView);
            } catch (Exception e) {
              e.printStackTrace();
            }
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
              ...
              @Override
              public void onClick(View v) {
                Intent intent = new Intent(OtherQuestionListActivity.this, ImagePagerActivity
                    .class);
