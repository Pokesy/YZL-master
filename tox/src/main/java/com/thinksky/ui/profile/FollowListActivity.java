...
public class FollowListActivity extends BaseBActivity {
  ...
  private void initData() {
    manageRpcCall(mAppService.getMyFollows(mUserId), new UiRpcSubscriberSimple<UserListModel>
        (this) {
      @Override
  ...
  class UserListAdapter extends RecyclerView.Adapter<UserViewHolder> {
    ...
    public void onBindViewHolder(UserViewHolder holder, int position) {
      ...
      ImageLoader.loadOptimizedHttpImage(FollowListActivity.this, NetConstant.BASE_URL + bean
