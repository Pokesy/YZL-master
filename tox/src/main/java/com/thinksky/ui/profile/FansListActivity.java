 ...
 */
public class FansListActivity extends BaseBActivity {
  ...
  private void initView() {
    ...
    titleBar.setMiddleTitle(TextUtils.equals(Url.USERID, mUserId) ? R.string
        .activity_fans_title_mine : R.string.activity_fans_title_other);
  ...
  class UserListAdapter extends RecyclerView.Adapter<UserViewHolder> {
    ...
    public UserViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View view = LayoutInflater.from(FansListActivity.this).inflate(R.layout
