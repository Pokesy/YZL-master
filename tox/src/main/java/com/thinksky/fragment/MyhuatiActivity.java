...
//        imgViewList.get(2).setVisibility(View.GONE);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyhuatiActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    private void initViewData() {
        RsenUrlUtil.execute(RsenUrlUtil.URL_MY_HUATI, new RsenUrlUtil.OnJsonResultListener<RemenhuatiBean>() {
            @Override
