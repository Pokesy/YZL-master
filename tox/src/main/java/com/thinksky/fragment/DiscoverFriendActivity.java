...
public class DiscoverFriendActivity extends BaseBActivity {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (imageItem.size() == 4) { //第一张为默认图片
                    Toast.makeText(DiscoverFriendActivity.this, "图片数3张已满", Toast.LENGTH_SHORT).show();
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(DiscoverFriendActivity.this);
