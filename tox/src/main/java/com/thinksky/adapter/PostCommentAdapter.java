...
public class PostCommentAdapter extends BaseAdapter {
  ...
  public PostCommentAdapter(Context ctx, List<PostComment> postCommentList, KJBitmap kjBitmap,
                            FinalBitmap finalBitmap, PostInfo postInfo, PostDetailCallBack
                                postDetailCallBack) {
    this.ctx = ctx;
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      holder.postComTime = (TextView) convertView.findViewById(R.id
          .Post_detail_comment_time_louceng);
      ...
      holder.mFloatLayout = (LinearLayout) convertView.findViewById(R.id
          .Post_detail_com_floatLayout);
      ...
      public void onClick(View v) {
        if (holder.mFloatLayout.isShown()) {
          ...
          holder.mFloatLayout.setVisibility(View.GONE);
                   ...
                   .RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,0.0f,Animation
...
//                postDetailCallBack.callback();
  ...
  static class Holder {
    TextView userName, postComTime, postComContent, com1Content, com2Content, moreCom,
        com1Username, com2Username, com1Time, com2Time;
