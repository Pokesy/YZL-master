...
public class Url {
    ...
    public static String OTHER_WEIBO = "/weibo/getHerWeibo";
    ...
    public static String SENDQUESTION = "/question/sendQuestion";
    public static String SENDDISCOVER = "user/setProfile&session_id=&signature=&email=&nickname=&Sex=&isfactory=&factory_name=&longitude=&latitude=&isdisplay=&mobile=&data=&address=";
    // 在论坛首页被点击的帖子
